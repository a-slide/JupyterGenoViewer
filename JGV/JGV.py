...
class JGV(object):
    ...
    def __init__ (self, fp, name=None, verbose=False, ref_list=[], output_index=False):
        ...
        * verbose
        ...
        self.reference = Reference(fp=fp, name=name, verbose=self.verbose, ref_list=self.ref_list, output_index=output_index)
    ...
    def add_annotation(self, fp, name=None):
        ...
        *  name
        ...
        self.annotations.append(Annotation(fp=fp, name=name, verbose=self.verbose, ref_list=self.ref_list))

    def add_alignement(self, fp, name=None, min_coverage=5, output_bed=False):
        """
         * fp
        ...
        * output_bed
        ...
        self.alignments.append(Alignment(fp=fp, name=name, verbose=self.verbose, min_coverage=min_coverage,
            ref_list=self.ref_list, output_bed=output_bed))
